...
public class SimplePublicUrlServiceTest {
    ...
    public void testExternalTarget() throws Exception {
        ...
        mockNode.setProperty(RedirectsService.PN_REDIRECT, "/noice");
        mockNode.setProperty(RedirectsService.PN_LINK, "https://www.noice.work");

        assertThat(_service.createTargetUrl(mockNode), equalTo("https://www.noice.work"));
        assertThat(_service.createRedirectUrl(mockNode), equalTo("https://www.demo-project.com/context/noice"));
    }
    ...
    public void testInternalTarget() throws Exception {
        MockNode mockNode = new MockNode("node");
        mockNode.setProperty(RedirectsService.PN_REDIRECT, "/noice");
        mockNode.setProperty(RedirectsService.PN_LINK, "123-456-789");
    ...
    public void testInternalTargetWithConfiguredPrefix() throws Exception {
        ...
        mockNode.setProperty(RedirectsService.PN_REDIRECT, "/noice");
        mockNode.setProperty(RedirectsService.PN_LINK, "123-456-789");
        _service.setTargetServerPrefix("https://www.noice.work");

        assertThat(_service.createTargetUrl(mockNode), equalTo("https://www.noice.work/internal/page.html"));
        assertThat(_service.createRedirectUrl(mockNode), equalTo("https://www.noice.work/noice"));
    }
